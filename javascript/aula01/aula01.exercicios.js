...
// 2) A partir do código abaixo, instancie um objeto do tipo Address informando os seguintes valores: cidade, estado e pais.
...
const addressPedro = new Address('Rio de Janeiro', 'RJ', 'Brasil');
